...
// // let catalystSDK;
// // let localCatalystApp;
// // let localCatalystConfig;
...
// //   if (localCatalystConfig !== undefined) {
// //     return localCatalystConfig;
// //   }
...
// //   if (localCatalystApp) {
// //     return localCatalystApp;
// //   }

// //   const sdk = getCatalystSDK();

// //   try {
// //     localCatalystApp = sdk.app(CATALYST_APP_NAME);

// //     return localCatalystApp;
// //   } catch {
// //     // The named app is created on first use below.
// //   }
...
// //   localCatalystApp = sdk.initializeApp(
// //     {
...
// // Zoho access tokens normally live for 60 minutes.
...
//   // ----------------------------------------------------------
//   // 2. PREVENT MULTIPLE SIMULTANEOUS TOKEN REQUESTS
//   // ----------------------------------------------------------

//   if (accessTokenPromise) {
//     console.log("Access token generation already in progress. Waiting...");
...
//       console.log("Access token cached for 59 minutes.");

//       return cachedAccessToken;
//     } finally {
//       // ------------------------------------------------------
//       // Allow another refresh after this request completes.
//       // ------------------------------------------------------
...
// //   // ----------------------------------------------------------
// //   // CATALYST REFRESH TOKEN CREDENTIAL
// //   // ----------------------------------------------------------

// let localCatalystApp = null;
// let localCatalystAppPromise = null;

// async function getLocalCatalystApp() {
//   // Already initialized
//   if (localCatalystApp) {
//     return localCatalystApp;
//   }

//   // Another request is currently initializing it.
//   // Reuse the same initialization promise.
//   if (localCatalystAppPromise) {
//     return localCatalystAppPromise;
//   }

//   localCatalystAppPromise = (async () => {
//     try {
//       const sdk = getCatalystSDK();
...
//       const usingLocalProjectKey = isPlaceholder(
//         process.env.CATALYST_PROJECT_KEY,
//       );
...
// export async function getCatalystApp(request) {
//   console.log("Initializing Catalyst SDK...");
...
// ============================================================
// GLOBAL CATALYST STATE
// ============================================================

// Use globalThis so the cached values can survive Next.js
// development hot reloads where possible.
...
export async function getZohoAccessToken() {
  ...
  // ----------------------------------------------------------
  // 2. PREVENT MULTIPLE TOKEN REQUESTS
  // ----------------------------------------------------------
...
function getLocalCatalystApp() {
  // ----------------------------------------------------------
  // 1. RETURN ALREADY INITIALIZED APP
  // ----------------------------------------------------------
  ...
  // ----------------------------------------------------------
  // 3. CREATE REFRESH TOKEN CREDENTIAL
  // ----------------------------------------------------------
  ...
  // ----------------------------------------------------------
  // 7. INITIALIZE CATALYST APP ONLY ONCE
  // ----------------------------------------------------------
